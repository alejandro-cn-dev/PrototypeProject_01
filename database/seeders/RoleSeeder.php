...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'categorias.index'])->syncRoles([$role2]);
        ...
        Permission::create(['name' => 'reportes.index'])->syncRoles([$role1]);

        Permission::create(['name' => 'marcas.index'])->syncRoles([$role2]);
        ...
        Permission::create(['name' => 'almacens.index'])->syncRoles([$role2]);
        ...
        Permission::create(['name' => 'ventas.index'])->syncRoles([$role2,$role3,$role4]);
        Permission::create(['name' => 'ventas.create'])->syncRoles([$role2]);
        Permission::create(['name' => 'ventas.delete'])->syncRoles([$role2]);

        Permission::create(['name' => 'compras.index'])->syncRoles([$role2,$role4]);
