...
@section('js')
    <script>
        ...
        function recargar_tabla() {
            ...
            $.ajax({
                url: "{{ route('json_reporte_ventas_producto') }}",
                type: "POST",
                data: {
                    param: criterio,
        ...
        function cargar_datos(resultado) {
            ...
            resultado.forEach(function(fila) {
                ...
                let fila_tabla = "<tr><td>" + fila.item_producto + "</td><td>" + fila.nombre + "</td><td>" + fila
                    .marca + "</td><td>" + fila.medida + "</td><td>" + fila.calidad + "</td><td>" + fila.unidad +
                    "</td><td>" + fila.precio_unitario + "</td><td>" + fila.ventas_totales + "</td><td>" + ((
                        parseInt(fila.precio_unitario, 10)) * (parseInt(fila.ventas_totales, 10))) + "</td></tr>";
