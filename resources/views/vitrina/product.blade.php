    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6">
                    @if (empty($imagenes))
                        <img class="card-img-top mb-5 mb-md-0" src="{{ asset('img/product_generic_img_3.jpg') }}"
                            alt="{{ $producto->nombre }} imagen" />
                    @else
                        <img class="card-img-top mb-5 mb-md-0" src="{{ asset('storage/img/' . $imagenes->nombre_imagen) }}"
                            alt="{{ $producto->nombre }} imagen" />
                    @endif
                </div>
                <div class="col-md-6">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><b>Calidad: </b>{{ $producto->calidad }}</li>
                        <li class="list-group-item"><b>Material: </b>{{ $producto->material }}</li>
                        @if ($producto->existencia > 0)
                            <li class="list-group-item"><b>Existencias:
                                </b>{{ $producto->existencia . ' ' . $producto->unidad . '(s)' }}</li>
                        @endif
                    </ul>
                    </p>
                    <div class="d-flex">
                            ...
                            <div class="card h-100">
                                ...
                                <a class="nav-link " href="/detalle/producto/{{ $producto->id }}">
                                    ...
                                    @foreach ($imagenes_rel as $imagen)
                                        ...
                                        @endif
                                    @endforeach
                                    <img class="card-img-top" style="width: 100%; height: 136px;"
                                        src="{{ asset($ruta_img) }}" alt="Imagen de {{ $producto->nombre }}" />
                                </a>
