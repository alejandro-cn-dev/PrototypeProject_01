    ...
    <div class="shadow-none p-3 bg-white rounded">
        <form action="/empleados/{{ $empleado->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input id="matricula" name="matricula" type="text" disabled class="form-control"
                    value="{{ $empleado->matricula }}" />
            </div>
            <div class="mb-3">
            ...
            <a href="/usuario/perfil" class="btn btn-secondary" tabindex="5">Cancelar</a>
