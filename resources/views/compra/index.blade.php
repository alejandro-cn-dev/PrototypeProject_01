...
@section('title')
  Compras o adquisiciones | {{config('system_name')}} Panel Admin
@stop
                ...
                <tr>
                    ...
                    <td>
                        <!-- <form action="{{route('compras.destroy',$compra->id)}}" method="POST"> -->
                            ...
                            <a class="btn btn-danger" id="anular" onclick="confirma_anular({{$compra->id}});"><i class="fas fa-fw fa-trash"></i> Eliminar</a>
                            @endcan
                        <!-- </form> -->
                    </td>
                </tr>
...
<script>
    ...
    function confirma_anular(numero){
        let ruta = "{{route('compras.destroy',':id')}}";
